...
#### 7.3 업종 선택
- ✅ 업종 카테고리 그룹 표시 (음식점, 카페/디저트, 주점, 기타)
- ✅ 업종 선택/해제 토글
- ✅ 선택된 업종 수 표시
...
#### 7.6 메시지 입력
- ✅ 메시지 내용 입력 (textarea)
- ✅ SMS: 바이트 카운터 및 SMS/LMS 자동 전환
- ✅ 카카오톡: 글자 수 표시
- ✅ 버튼 추가 (카카오톡 전용, 최대 5개)

#### 7.7 비용 계산
- ✅ SMS: 200원/건
- ✅ 카카오톡: 텍스트 200원, 이미지 230원
- ✅ 예상 비용 계산 (인원 × 단가)
- ✅ 현재 잔액 표시
- ✅ 잔액 부족 시 발송 버튼 비활성화

#### 7.8 예상 마케팅 효과
- ✅ 예상 방문율 표시 (SMS 4.5%, 카카오톡 7.6%)
- ✅ 예상 방문 인원 계산
- ✅ 예상 매출 계산
...
- ✅ 테스트 발송 버튼
- ✅ 테스트 발송 결과 메시지
- ⚠️ 테스트 발송은 E2E에서 **1회만** 실행

#### 7.10 미리보기 (데스크톱)
- ✅ SMS: iPhone 문자 미리보기
- ✅ 카카오톡: 카카오톡 브랜드 메시지 미리보기
- ✅ 미리보기가 sticky로 스크롤 따라감
- ✅ 메시지 내용 실시간 반영

#### 7.11 메시지 발송
- ✅ 필수 조건 미충족 시 발송 버튼 비활성화
- ✅ 카카오톡 발송 불가 시간대(20:50~08:00) 안내
- ✅ 발송 성공 시 성공 메시지 표시
- ✅ 발송 실패 시 에러 메시지 표시
