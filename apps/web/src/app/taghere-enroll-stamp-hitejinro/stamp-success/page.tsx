      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center">
        <div className="w-full max-w-md bg-white rounded-t-[10px] overflow-hidden animate-slide-up">
          ...
          <div className="px-5 pt-4 pb-[max(30px,env(safe-area-inset-bottom))]">
            <button onClick={onClose} className="w-full py-4 bg-[#00A859] text-white font-semibold text-base rounded-[10px] leading-[1.3]">
              확인했어요
            </button>
          </div>
        </div>
              ...
              {Array.from({ length: 10 }, (_, i) => {
                ...
                return (
                  <div key={num} className="flex flex-col items-center gap-1">
                    ...
                    {hasReward && <span className="text-[10px] font-semibold text-[#00A859]">보상</span>}
                  </div>
                );
              })}
            </div>
